...
reading_time: "4 min"
language: "pl"
slug: "z-notatnika-psychodietetyka-o-czym-jest-ten-chips"
published: false
...
A może ten cichy głos w środku, który zaczęła odzyskiwać:

*„O czym to jest? Czego ja teraz naprawdę potrzebuję?”*

Usiadła. Wzięła kilka głębszych oddechów.

Zrozumiała, że nie jest głodna.
Jest zmęczona.
Przytłoczona.
Nikt jej dziś nie zapytał, jak się czuje.
A ona też siebie o to nie zapytała.
...
- Czy chodzi o smak… czy może o emocje?

Może ten chips to **potrzeba ulgi** po trudnym dniu.
Może to ciastko to **chęć bliskości**, której zabrakło.
Może ta zachcianka to sposób na **nudę, napięcie, zmęczenie albo samotność**.

---

## Uważność zamiast automatu

Jedzenie nie powinno być jedynym sposobem radzenia sobie z emocjami.

Zamiast oceniać swoje wybory, spróbuj je **zrozumieć**.
Dopiero wtedy możesz świadomie zdecydować:

- Czy naprawdę chcę to zjeść?
- Czy może potrzebuję czegoś innego?

To nie jest zakaz.
To zaproszenie do uważności.
Do lepszego kontaktu ze sobą.
Do zauważenia.
Do budowania relacji z jedzeniem opartej na trosce, a nie na automacie.
